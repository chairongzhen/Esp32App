...
//        vLogin.backgroundColor = UIColor.white
        ...
        let image = UIImage(named: "loginLogo")
//        let reSize = CGSize(width: 100, height: 100)
        imgLogo = UIImageView(image: image)
        imgLogo.frame = CGRect(x:kScreenW / 2 - 150, y:30, width:100, height:100)
        
        vLogin.addSubview(imgLogo)
        // owl left gone
...
//        self.view.addSubview(imgRightHandGone)
        ...
        // user input
        lbUser = UILabel(frame: CGRect(x: kScreenW / 2 - 50, y: 30, width: 100, height: 30))
        lbUser.textColor = .orange
        lbUser.text = "邮件地址"
        lbUser.font=UIFont.systemFont(ofSize:14)
        
        
        vLogin.addSubview(lbUser)
